...
<div class="container-fluid">
  ...
  <textarea type = "text" rows= "15" cols=100% style="resize:none; width: 70%; border:solid 5px #666666" disabled>
    <?php htmlout($storytext); ?></textarea>
    <form action = "postsuccess.html.php" method = "post">
       <textarea type = "text" name = "newtext" rows= "15" cols=100% style="border:solid 7px #666666; resize:none" placeholder="Start writing here..."></textarea>
